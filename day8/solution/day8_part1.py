...
for i in range(0,1000):
    ...
    if oneCircuitTuple[0]:
        ...
        print("is in one circuit")
    elif twoCircuitTuple[0]:
        print("ersterCircuit vorher: " + str(circuits[twoCircuitTuple[1]]))
        circuits[twoCircuitTuple[1]].update(minConnection, circuits[twoCircuitTuple[2]])
        print("ersterCircuit nachher: " + str(circuits[twoCircuitTuple[1]]))
        print("zweiterCircuit vorher: " + str(circuits[twoCircuitTuple[2]]))
        print("zweiterCircuit +1 vorher: " + str(circuits[twoCircuitTuple[2]+1]))
        circuits.pop(twoCircuitTuple[2])
        print("zweiterCircuit nachher: " + str(circuits[twoCircuitTuple[2]]))
        print("is in two circuits")
    else:
        circuits.append(set(minConnection))
        print("is a new circuit")
    print("circuits grade: " + str(circuits))
